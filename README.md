...
## Know issues
SVG preloading (and rasterization) looks like it may be broken on opening the slides directory.
The SVGs are rasterized on first viewing, causing some very small latency on initial moving through the slides
