...
## Known issues
### MacOS
  - The child slides view does not like being left of the parent notes view. Probably for the same reason the view cannot be maximized.

## Eventual goals
  [x] Viewing `#speaker-note[...]` in the speaker note view
  [] Parsing speaker notes is currently a hack, maybe use `typst-lib`?
  [] Making it less shaky at least on MacOS
